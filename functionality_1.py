...
def funz_1():
    ...
    if scelta == "a2q":
        ...
        fig_plot(degree_1, a2q_2y_g.nodes.keys())
    ...
    if scelta == "c2a":
        ...
        fig_hist(degree_2)
        print("We want to visualize for each user how many degree it has")
        fig_plot(degree_2, c2a_2y_g.nodes.keys())
        ...
        fig_hist(degree_2)
        print("We want to visualize for each user how many degree it has")
        fig_plot(degree_2, c2q_2y_g.nodes.keys())
...
def fig_plot(degree_1, nodes):
    ...
    #plot
    plt.bar(nodes, degree_1, color = "darkblue")
